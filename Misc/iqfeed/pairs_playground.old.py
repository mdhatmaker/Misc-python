...
# Create 1-MINUTE NSEQ Spread
dt1a = datetime(2017, 5, 1)
dfnq = get_historical_contract("@NQ#", dt1a, dt2, interval=interval_1min)
dfes = get_historical_contract("@ES#", dt1a, dt2, interval=interval_1min)
df = get_spread(dfnq, dfes, spread_price_NQES, suffixes=('_NQ','_ES'))
...
# Create DAILY NSEQ Spread
dfnq = get_historical_contract("@NQ#", dt1, dt2)
