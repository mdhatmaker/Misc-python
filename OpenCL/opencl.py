...
if __name__ == "__main__":
	...
	## It would be necessary to add some code to check the support for the necessary platform extensions with device.extensions
	
	## Step #2. Obtain a device id for at least one device (accelerator).
	device = platform.get_devices()[0]

	## It would be necessary to add some code to check the support for the necessary device extensions with device.extensions
